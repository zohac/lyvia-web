...
sources:
  - label: "CNGOF / GEMVi — Recommandations pour la Pratique Clinique : Les femmes ménopausées (2021)"
    url: "https://www.sciencedirect.com/science/article/pii/S2468718921000593"
  - label: "Inserm — Dossier Ménopause (2024)"
    url: "https://www.inserm.fr/dossier/menopause/"
  - label: "Haute Autorité de Santé — PNDS Insuffisance Ovarienne Prématurée (2021, Centre FIRENDO)"
    url: "https://www.has-sante.fr/jcms/p_3737819/"
  - label: "NICE Guideline NG23 — Menopause: identification and management (révision 2024)"
    url: "https://www.nice.org.uk/guidance/ng23"
  - label: "SWAN — Paramsothy et al., Durée de la transition ménopausique (Menopause, 2017)"
    url: "https://pubmed.ncbi.nlm.nih.gov/27749738/"
  - label: "STRAW+10 — Stages of Reproductive Aging Workshop (Harlow et al., 2012)"
    url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3340903/"
  ...
  - label: "IMS — Global Consensus on Testosterone Therapy for Women (2019)"
...
- La périménopause commence en médiane vers **45-47 ans** (plage 40-50) et dure environ **4 ans** (jusqu'à 8-10 ans pour celles qui démarrent tôt) avant la ménopause confirmée — définie par 12 mois sans règles.
- Les 4 signes les plus fréquents : cycles irréguliers, bouffées de chaleur, troubles du sommeil, humeur plus labile.
- Il n'existe pas de test de sang fiable pour « diagnostiquer » la périménopause — c'est l'ensemble des signes + l'âge qui comptent (NICE NG23 révisé 2024, CNGOF-GEMVi 2021).
...
![Timeline des trois phases de la transition ménopausique : périménopause précoce, périménopause tardive, ménopause confirmée — avec âges moyens et durées typiques](/images/articles/signes-perimenopause-timeline.webp)

Médicalement, on distingue trois stades :

- **Périménopause précoce** : cycles encore présents mais de longueur variable (plus courts ou plus longs qu'avant, écarts de 7 jours ou plus).
...
L'âge moyen de la ménopause en France est **51 ans** selon l'Inserm. La périménopause démarre en médiane vers **45-47 ans**, avec une plage normale allant de 40 à 50 ans.
...
Plusieurs de ces symptômes ne sont pas spécifiques à la périménopause. Ils peuvent aussi signaler :

- **Un hyperthyroïdisme** : pertes de poids inexpliquées, tachycardie, tremblements, règles légères. Une prise de sang TSH élimine la question en 48h.
- **Une hypothyroïdie** : prise de poids, frilosité, fatigue, constipation, peau sèche. Même test sanguin.
- **Un syndrome prémenstruel sévère** (SPM) : symptômes cycliques étroitement liés à la phase lutéale, disparaissant avec les règles.
- **Un épuisement professionnel ou personnel** : sommeil, humeur, concentration — le trio peut mimer une périménopause.
- **Une dépression** : humeur triste persistante, anhédonie, culpabilité, troubles du sommeil.

La différence se fait souvent sur la **constellation** de symptômes et la **régularité des cycles**. Des règles parfaitement régulières avec des bouffées de chaleur → ce n'est probablement pas de la périménopause. Des cycles qui partent dans tous les sens avec plusieurs autres signes → c'est très probable.

Un bilan médical simple (prise de sang + entretien) permet d'écarter les faux amis en une consultation.

## Combien de temps dure la périménopause ?

La durée médiane est d'environ **4 ans**, avec une forte variabilité selon l'âge auquel commence la transition. L'étude américaine de référence sur le sujet (Paramsothy, *Menopause* 2017, données SWAN) observe **~4,4 ans** pour les femmes entrant dans la transition tardivement, et jusqu'à **~8,6 ans** pour celles qui commencent tôt. Certaines traversent la transition en 2 ans, d'autres en 10. Il n'y a pas de pronostic individuel fiable.

Ce qui bouge au fil des années :

- **Les 2-3 premières années** : cycles irréguliers, peu ou pas de bouffées de chaleur, humeur parfois changée.
- **La phase intermédiaire** : bouffées plus marquées, sommeil plus touché, seins qui se calment.
- **Les 1-2 dernières années avant la ménopause** : cycles très espacés (60+ jours), bouffées à leur pic pour celles qui en ont.

Une fois la ménopause confirmée (12 mois sans règles), certains symptômes s'atténuent naturellement en quelques mois, d'autres (bouffées, sécheresse vaginale) peuvent persister plusieurs années.

## Quand (et pourquoi) en parler à un médecin

Pas besoin d'attendre que la vie soit invivable. Les bons moments pour consulter :

- **Quand un symptôme gêne votre quotidien** : sommeil haché plusieurs nuits par semaine, humeur qui affecte vos relations, travail qui en pâtit.
- **Quand vous avez moins de 40 ans** avec plusieurs de ces signes : une insuffisance ovarienne prématurée mérite un bilan spécifique (elle touche environ 1 % des femmes et a des implications sur la santé cardiovasculaire et osseuse à long terme).
- **Quand vous avez des saignements anormalement abondants ou prolongés** (>7 jours, besoin de double protection) : ça mérite une échographie pelvienne pour écarter un problème gynécologique.
...
Oui, c'est possible, mais ça mérite un bilan. Avant 40 ans, on parle d'*insuffisance ovarienne prématurée* (IOP) et les recommandations françaises (PNDS HAS 2021 via le Centre FIRENDO) comme internationales (ESHRE 2024) sont alignées : **FSH dosée à deux reprises à au moins 4 semaines d'intervalle**, bilan œstradiol / AMH, caryotype, **recherche de prémutation FMR1** (X fragile, cause génétique la plus fréquente), bilan auto-immun incluant les **anticorps anti-21-hydroxylase** (auto-immunité surrénalienne), bilan cardio-métabolique (lipides, glycémie) et densitométrie osseuse. L'IOP a des conséquences au-delà des symptômes (risque cardiovasculaire et osseux à long terme) qui justifient généralement un traitement hormonal substitutif jusqu'à l'âge moyen de ménopause (~51 ans).

### Puis-je encore tomber enceinte en périménopause ?

Oui — et c'est une source de surprises. Tant que vous n'êtes pas en aménorrhée de 12 mois consécutifs, une grossesse reste possible, même avec des cycles très irréguliers. Les recommandations de contraception restent actives jusqu'à 1 an après les dernières règles (2 ans si elles surviennent avant 50 ans).

### La périménopause fait-elle grossir automatiquement ?

Pas automatiquement, mais la redistribution de la graisse vers l'abdomen et la perte progressive de masse musculaire sont documentées. Ce n'est pas une fatalité : l'activité physique (incluant du renforcement musculaire, pas seulement du cardio) et une alimentation riche en protéines limitent nettement ces changements.
...
La périménopause, c'est une période où beaucoup d'informations arrivent en même temps, souvent contradictoires. Traitements hormonaux ou pas, phyto-œstrogènes utiles ou pas, alimentation à revoir comment, quel niveau d'activité physique. Démêler ce qui vous concerne vraiment, vous, avec votre histoire et vos symptômes, c'est ce qui prend du temps.

Travailler avec une spécialiste formée à la ménopause, c'est faire ce tri à deux. Comprendre ce qui se passe dans votre corps en ce moment précis, identifier les deux ou trois leviers qui auront vraiment un effet dans votre quotidien, et construire un plan qui tient dans une vie déjà pleine.

Un appel découverte de 15 minutes suffit à voir si ça vous correspond — sans engagement, sans jargon, juste une conversation pour poser vos questions.
