...
<template>
  <button
    ...
    class="inline-flex h-12 w-full items-center justify-center gap-2 rounded-[var(--radius-sm)] px-6 text-center font-bold leading-none transition-colors duration-150 ease-in-out focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[rgba(200,121,100,0.2)]"
    :class="
      disabled || loading
