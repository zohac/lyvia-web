...
withDefaults(
  defineProps<{
    ...
    disabled?: boolean
    /**
     * When provided, the button is rendered as a link (NuxtLink) for navigation CTAs.
     */
    to?: string
...
<template>
  <NuxtLink
    ...
    :class="[
      ...
      'h-auto',
      disabled || loading
        ? 'pointer-events-none cursor-not-allowed bg-[color:var(--color-brand-subtle)] text-[color:var(--color-brand-secondary)]'
