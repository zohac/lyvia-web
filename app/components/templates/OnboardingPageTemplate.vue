      ...
      <header class="flex flex-col items-center gap-4 text-center">
        ...
        <div class="grid gap-2">
          <h1
            ...
            class="font-serif text-[1.75rem] font-bold leading-[var(--leading-tight)] tracking-[-0.01em] text-[color:var(--color-brand-primary)] sm:text-[2.25rem] focus:outline-none focus:ring-4 focus:ring-[rgba(200,121,100,0.2)]"
          >
            {{ title }}
          </h1>
          <p
